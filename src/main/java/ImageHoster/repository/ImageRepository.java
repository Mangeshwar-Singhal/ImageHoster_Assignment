...
public class ImageRepository {
    ...
    public Image getImageByTitle(Integer imageId, String imageTitle) {
        EntityManager em = emf.createEntityManager();
        try {
            TypedQuery<Image> typedQuery = em.createQuery("SELECT i from Image i where i.id =:imageId and i.title =:imageTitle", Image.class).setParameter("imageId", imageId).setParameter("imageTitle", imageTitle);
